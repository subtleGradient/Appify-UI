...
public struct WebappHostConfiguration: Equatable, Sendable {
    ...
    public var aboutNotice: WebappHostAboutNotice?
    ...
    public init(
        ...
        logName: String,
        aboutNotice: WebappHostAboutNotice?
    ) {
...
public struct WebappHostAboutNotice: Equatable, Sendable {
...
public enum WebappHostConfigurationLoader {
    ...
    public static func parseAboutNotice(from hostSettings: [String: Any]) -> WebappHostAboutNotice? {
