...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func showGettingStarted() {
        ...
        alert.informativeText = "Create a new canvas or open an existing .\(configuration.documentExtensions.first ?? "tlcanvas") package."
    ...
    private func showNewDocumentPanel() {
        ...
        panel.nameFieldStringValue = "Untitled.\(configuration.documentExtensions.first ?? "tlcanvas")"
