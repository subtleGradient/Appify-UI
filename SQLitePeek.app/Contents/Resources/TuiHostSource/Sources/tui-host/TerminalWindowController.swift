...
final class TerminalWindowController: NSWindowController, WKNavigationDelegate {
    ...
    init(configuration: TuiHostConfiguration, packageURL: URL) {
        ...
        let title = TerminalWindowController.windowTitleDetail(
    ...
    private static func windowTitleDetail(
        ...
        case .folderMarker:
            workingDirectory?.lastPathComponent.nonEmpty ?? documentURL.deletingPathExtension().lastPathComponent
        case .fileDocument:
